...
export default function RentalProductsGrid({ products, onBook }: Props) {
  if (products.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-muted-foreground">لا توجد منتجات متاحة للإيجار حالياً</p>
      </div>
    )
  }
          ...
          <CardContent className="flex-1 space-y-4">
            ...
            <div className="bg-muted/50 rounded-lg p-3">
              ...
              <p className="text-2xl font-bold text-primary">
                {product.price}
                <span className="text-lg ml-2">ريال/يوم</span>
              </p>
            </div>
          </CardContent>
